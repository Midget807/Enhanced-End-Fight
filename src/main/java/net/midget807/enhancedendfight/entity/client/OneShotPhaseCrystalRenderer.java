...
public class OneShotPhaseCrystalRenderer extends EntityRenderer<OneShotPhaseCrystal> {
    private static final ResourceLocation TEXTURE = EnhancedEndFightMain.id("textures/entity/one_shot_crystal.png");
    ...
    public OneShotPhaseCrystalRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    public void render(OneShotPhaseCrystal entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    public boolean shouldRender(OneShotPhaseCrystal livingEntity, Frustum camera, double camX, double camY, double camZ) {
        return super.shouldRender(livingEntity, camera, camX, camY, camZ) || livingEntity.getBeamTarget() != null;
    }

    @Override
    public ResourceLocation getTextureLocation(OneShotPhaseCrystal entity) {
        return TEXTURE;
    }
}
